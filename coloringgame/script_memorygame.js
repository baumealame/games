...
GAME8.Game = (function () {
    ...
    if (!$(this).hasClass("active")) {
      ...
      if (hit === true) {
        ...
        activeCards[0]
          .add(activeCards[1])
          .unbind()
          .addClass("wobble cursor-default");
        activeCards = [];
  ...
  function endGame() {
    ...
    if (timeFromStorage != undefined && timeFromStorage != "") {
      ...
      if (
        time.minutes < timeFromStorage.minutes ||
        (time.minutes == timeFromStorage.minutes &&
          time.seconds < timeFromStorage.seconds)
      ) {
  ...
  function checkActiveCards(connections) {
    return (
      connections[0].data("connection") === connections[1].data("connection")
    );
  }
    ...
    cards: [
      {
        ...
        year: "(대한민국, 1901–1988)",
        quote:
          "“남자가 하는 일 중에 여자라고 못할 일이 뭐가 있소.<br>이끌어야지. 앞장서서 이끌란 말이야.<br>달에다 내 발바닥 지문을 탁 찍고 오겠다는 패기 정도는 가져야 하지 않겠는가.”",
        connectionID: 1,
      },
      {
        backImg: "./img/01.png",
      ...
      },
      {
        ...
        year: "(대한민국, 1896–미상)",
        quote:
          "“조선아 내가 너를 영결할 때, 죽은 시체에게라도 더 학대해다오.<br>그래도 부족하거든 이다음에 나 같은 사람 나더라도,<br>할 수 있는 대로 또 학대해보아라.”",
        connectionID: 2,
      },
      {
        backImg: "./img/02.png",
      ...
      },
      {
        ...
        year: "(대한민국, 1876–1910)",
        quote:
          "“지금 포기한다면 내겐 그 어떤 기회도 없다는 것을 잘 압니다.<br>그러므로 그것이 신의 뜻이라 해도 의사 공부를 포기할 생각이 없습니다.”",
        connectionID: 3,
      },
      {
        backImg: "./img/03.png",
...

      {
        ...
        year: "(대한민국, 1923–2017)",
        quote:
          "“나는 하루라도 더 살고 싶다.<br>우리나라 여성 영화인들이 좋은 작품을 만들고<br>세계로 진출하는 것도 보고 싶다.”",
        connectionID: 5,
      },
      {
        backImg: "./img/09.png",
      ...
      },
      {
        ...
        year: "(대한민국, 1908–1995)",
        quote:
          "“칼을 들이대면 겁먹을 줄 아느냐?<br>우리는 죽을 각오로 나왔다.”",
        connectionID: 6,
      },
      {
        backImg: "./img/12.png",
      ...
      },
      {
        ...
        year: "(대한민국, 1914–1998)",
        quote:
          "“귀중하게 태어난 인간,<br>법 앞에서라도 만인이 다 평등하게 살아야 한다.”",
        connectionID: 7,
      },
      {
        backImg: "./img/14.png",
      ...
      },
      {
        ...
        year: "(대한민국, 1902–1991)",
        quote:
          "“남의 아내, 남의 며느리가 되어<br>한갓 그 집안 시부모와 남편 한 사람만을 공경하는 것보다<br>오히려 사람으로서의 개성을 살리고 인권을 차지하는 것이<br>우리 눈앞에 급박한 큰 문제다.”",
        connectionID: 8,
      },
      {
        backImg: "./img/19.png",
