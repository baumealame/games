...
document
  .getElementById("result-image-layer")
...
function OpenAndDownload(canvas) {
  ...
  if (!IOS()) {
    ...
    document.getElementById("result-image-layer").appendChild(result_capture);
    $(document.getElementById("result-image-layer")).fadeIn(200);
